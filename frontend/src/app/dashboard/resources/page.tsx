  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Knowledge Resources</h1>
        <button 
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded"
          onClick={() => {/* Add new resource function */}}
        >
          Add New Resource
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded relative mb-6">
          ...
          <p className="mt-2">You haven't added any knowledge resources yet. Click the "Add New Resource" button to get started.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {resources.map((resource) => (
            <div key={resource._id} className="border rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            {[
              {
                ...
                description: "Comprehensive guide to analyzing market trends and opportunities",
                category: "Education",
                url: "#"
              },
              {
                title: "Investor Psychology",
                description: "Understanding behavioral finance and investor psychology",
                category: "Psychology",
                url: "#"
              },
              {
                title: "Risk Management",
                description: "Advanced techniques for managing investment risk",
                category: "Strategy",
                url: "#"
              }
            ].map((resource, index) => (
